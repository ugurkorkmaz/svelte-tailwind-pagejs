...
var app = (function () {
    ...
    /* src\routes\auth\Signup.svelte generated by Svelte v3.49.0 */
    ...
    const auth = writable(true);

    /* src\routes\auth\Signin.svelte generated by Svelte v3.49.0 */
    const file = "src\\routes\\auth\\Signin.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "w-6");
    			add_location(button, file, 14, 0, 249);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ auth, page, login });
    	return [login];
    }
    ...
    /* src\routes\auth\ForgotYourPassword.svelte generated by Svelte v3.49.0 */
    ...
    function instance$1($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ForgotYourPassword', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ForgotYourPassword> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class ForgotYourPassword extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		page(
    			...
    			() => {
    				if (route.auth && $auth) {
    					...
    					$$invalidate(0, current = route.component);
    				}
    			}
    		);
    	});
